...
class TestPublicLandingPage:
    ...
    def test_public_yes(self, page: Page):
        ...
        expect(page.get_by_role("heading", name="Legal action against police and public organisations")).to_be_visible()
        page.get_by_role("button", name="Continue").click()
        expect(page.get_by_text("Is this to do with police, prisons or detention centres?")).to_be_visible()
