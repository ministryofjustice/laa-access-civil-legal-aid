...
def test_change_domestic_abuse(page: Page):
    ...
    page.get_by_role("link", name="Help to keep yourself safe and protect children").click()
...
def test_bug_lga_3746_multiple_subcategories(page: Page):
    ...
    page.get_by_role("link", name="Domestic abuse").click()
    page.get_by_role("link", name="Problems with neighbours, landlords or other people").click()
