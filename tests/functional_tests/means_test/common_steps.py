...
def fail_means_test(page: Page):
    ...
    page.get_by_role("group", name="Maintenance received").get_by_label("Amount").fill("9999999")
    ...
    page.get_by_role("group", name="Pension received").get_by_label("Amount").fill("999999")
    page.get_by_role("group", name="Pension received").get_by_label("Frequency").select_option("per_week")
    page.get_by_role("group", name="Any other income").get_by_label("Amount").click()
    page.get_by_role("group", name="Any other income").get_by_label("Amount").fill("999999")
    page.get_by_role("group", name="Any other income").get_by_label("Frequency").select_option("per_week")
    page.get_by_role("button", name="Continue").click()
