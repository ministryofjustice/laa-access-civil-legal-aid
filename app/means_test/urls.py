from app.categories.results.views import HLPASResultPage, MeansTestResultPage
...
result.add_url_rule("/refer", view_func=MeansTestResultPage.as_view("ineligible", "means_test/refer.html"))
result.add_url_rule(
    "/hlpas",
