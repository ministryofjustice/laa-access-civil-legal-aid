...
bp.add_url_rule(
    "/eligible",
    view_func=EligibleContactUsPage.as_view("eligible", template="contact/eligible.html", attach_eligibility_data=True),
)
...
bp.add_url_rule(
    ...
    view_func=FastTrackedContactUs.as_view("contact_us_fast_tracked", attach_eligibility_data=False),
)
